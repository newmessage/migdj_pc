...
var TEXT={
    EN: {
            ...
            TUTORIAL_TAP_DESKTOP:       'Enter to continue',
            TUTORIAL_TEXT:              'Tap the buttons and scratch the disc as the notes approach you.',
            TUTORIAL_TEXT_DESKTOP:      'Press 1, 2, 3 buttons and scratch the disc as the notes approach you.', 
            TUTORIAL_TITLE:             'Be a great DJ in 38s!',
    ...
    FR: {
            ...
            TUTORIAL_TAP_DESKTOP:       'Enter pour continuer',
            TUTORIAL_TEXT:              'Touche les icônes et scratche pendant que les notes défilent vers toi.',
            TUTORIAL_TEXT_DESKTOP:      'Appuyez sur 1, 2, 3 boutons et de rayer le disque que les notes que vous approchent.', 
    ...
    ES: {
            ...
            TUTORIAL_TAP_DESKTOP:       'Enter para continuar',
            TUTORIAL_TEXT:              'Toca los iconos y haz scratch con el disco a medida que las notas se te acercan.',
            TUTORIAL_TEXT_DESKTOP:      'Pulse 1, 2, 3 botones y rayar el disco como las notas que se aproximan.', 
    ...
    IT: {
            ...
            TUTORIAL_TAP_DESKTOP:       'Enter per continuare',
            TUTORIAL_TEXT:              'Tocca i pulsanti e scratcha i piatti quando le note si avvicinano.',
            TUTORIAL_TEXT_DESKTOP:      'Premere 1, 2, 3 pulsanti e graffiare il disco come le note si avvicina.', 
    ...
    DE: {
            ...
            TUTORIAL_TAP_DESKTOP:       'Enter: Weiter',
            TUTORIAL_TEXT:              'Berühre die Tasten und scratche die Scheibe, während sich die Noten nähern.',
            TUTORIAL_TEXT_DESKTOP:      'Tryk på 1, 2, 3 knapper og ridse disken som noterne nærmer dig.', 
