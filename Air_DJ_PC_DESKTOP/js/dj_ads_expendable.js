...
function stepchange()
{
	...
	case 'default':
		...
		expandbtn.innerHTML = '<img src="http://gllive-alpha.gameloft.com/~hung.nguyenminh/ads/release/img/ads_banner/ads_banner.png" width="320px" height="50px"/>';
		expandbtn.setAttribute('onclick', 'expand()');
		expandbtn.setAttribute('type', 'submit');
		expandbtn.id = 'expandbtn';
		expandbtn.className = 'btn';
		expandbtn.appendChild(document.createTextNode('Play!'));
		expandbtn.style.position = 'absolute';
		expandbtn.style.width = '100%';
		expandbtn.style.height = '100%';
		expandbtn.style.left = 0 + 'px';
		expandbtn.style.top = 0 + 'px';
	...
	case 'expanded':
		...
		var posdivtxt = document.createElement("div");
                posdivtxt.setAttribute('id', 'posid');

                posdivtxt.innerHTML='<object type="text/html" data="http://gllive-alpha.gameloft.com/~hung.nguyenminh/ads/release/" width="375px" height="667px"></object>';
                maindiv.appendChild(posdivtxt);
		break;
	}
}
